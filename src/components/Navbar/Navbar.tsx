  ...
  const menus: MenuItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        dropdown: {
          items: [
            { label: "Миссия и философия", to: "/about" },
            { label: "Научный подход", to: "/about" },
            { label: "Лабораторная база", to: "/about" },
            { label: "Сертификация, стандарты, протоколы", to: "/about" },
            { label: "Международные связи", to: "/about" },
          ],
        },
      },
      {
        ...
        dropdown: {
          items: [
            { label: "Клеточные технологии", to: "/services" },
            { label: "Регенеративная терапия", to: "/services" },
            { label: "Биоматериалы", to: "/services" },
            { label: "Персонализированная медицина", to: "/services" },
            { label: "Инфографика / схемы / анимации", to: "/services" },
          ],
        },
      },
      {
        ...
        dropdown: {
          items: [
            { label: "Ортопедия", to: "/therapy/orthopedics" },
            { label: "Неврология", to: "/therapy/neurology" },
            { label: "Anti-age / longevity", to: "/therapy/longevity" },
            { label: "Восстановительная медицина", to: "/therapy/rehab" },
          ],
        },
      },
      {
        ...
        dropdown: {
          items: [
            { label: "Врачи, ученые, эксперты", to: "/team" },
            { label: "Фото + научный профиль", to: "/team" },
            { label: "Квалификация и опыт", to: "/team" },
          ],
        },
      },
      {
        ...
        dropdown: {
          items: [
            { label: "Клинические исследования", to: "/science" },
            { label: "Публикации", to: "/science/publications" },
            { label: "Научные партнерства", to: "/science/partners" },
          ],
        },
      },
      {
        ...
        dropdown: {
          items: [
            { label: "Как проходит лечение", to: "/patients" },
            { label: "Безопасность", to: "/patients/safety" },
            { label: "Вопросы и ответы", to: "/patients/faq" },
            { label: "Этика и доказательная медицина", to: "/patients/ethics" },
          ],
        },
      },
      {
        ...
        to: "/projects",
        dropdown: {
          items: [{ label: "Проекты (добавим позже)", to: "/projects" }],
        },
      },
      {
        key: "contacts",
        ...
        dropdown: {
          items: [
            { label: "Интерактивная карта", to: "/contacts#map" },
            { label: "Форма заявки", to: "/contacts#form" },
            { label: "Способы связи", to: "/contacts#info" },
          ],
        },
      },
    ],
